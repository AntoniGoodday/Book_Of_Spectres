...
=== featureShowcase ===
Phoebe: Hello!
<expression=Smug>Welcome to the current iteration of the dialogue system.
<expression=Surprised>It's not much right now, but we can do stuff like <expression=Think>. . . <expression=Smug><rainb> WACKY EFFECTS </rainb>
<expression=Neutral>There is also...
Axolotl-imageright: <shake>Skreee!!!</shake>
Phoebe-imageleft: <expression=Angry>How <shake>DARE</shake> this spectre interrupt my <expression=Smug><slide>AMAZING</slide> speech!
<expression=Neutral>Time to get rid of 'em.
-> END
...
=== battleFlavourText ===
<bounce a=1 f=1 w=0.2>{~You feel like you're going to have a bad time.|You felt your sins crawling on your back.}</bounce>
-> battleFlavourText
